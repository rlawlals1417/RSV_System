	...
	<!--  <input type="hidden" name=""> -->
	 ...
	 <table>
			...
			<tbody>
				<tr>
					<th>학생이름</th>
					<td colspan="2"><input name="upload_name" value="${vo.getUpload_name() }" type="text"/></td>
				</tr>
				<tr>
					<th>수강과목</th>
					<td colspan="2"><input name="upload_class" value="${vo.getUpload_class() }" type="text"/></td>
				</tr>
				<tr>
					<th>전화번호</th>
					<td colspan="2"><input name="upload_tel" value="${vo.getUpload_tel() }" type="text"/></td>
				</tr>
				<tr>
				...
				<tr>
					<th>담당멘토</th>
					<td colspan="2"><input name="upload_writer" value="${vo.getUpload_writer() }"type="text"/></td>
				</tr>
		
				<tr>
					<th>비밀번호</th>
					<td colspan="2"><input name="upload_pwd" value="${vo.getUpload_pwd() }" type="password"/></td>
