...
public class UploadVO {
	...
	public void setUpload_no() {this.upload_no = upload_no;}
	
	public String getUpload_regdate() {return upload_regdate;}
	public void setUpload_regdate() {this.upload_regdate = upload_regdate;}
	
	public String getUpload_name() {return upload_name;}
	public void setUpload_name() {this.upload_name = upload_name;}
	
	public String getUpload_class() {return upload_class;}
	public void setUpload_class() {this.upload_class = upload_class;}
	
	public String getUpload_tel() {return upload_tel;}
	public void setUpload_tel() {this.upload_tel = upload_tel;}
	
	public String getUpload_writer() {return upload_writer;}
	public void setUpload_writer() {this.upload_writer = upload_writer;}
	
	public String getUpload_comment() {return upload_comment;}
	public void setUpload_comment() {this.upload_comment = upload_comment;}
	
	public int getUpload_pwd() {return upload_pwd;}
	public void setUpload_pwd() {this.upload_pwd = upload_pwd;}
	
	public int getUpload_month() {return upload_month;}
	public void setUpload_month() {this.upload_month = upload_month;}
	
	public int getUpload_day() {return upload_day;}
	public void setUpload_day() {this.upload_day = upload_day;}
	
	
	/*-----------------------------------------------------------------------------------------*/

	public int getUpload_start_time() {return upload_start_time;}
	public void setUpload_start_time() {this.upload_start_time = upload_start_time;}
	
	public int getUpload_end_time() {return upload_end_time;}
	public void setUpload_end_time() {this.upload_end_time = upload_end_time;}
